    ...
    children: [
      ...
      makeTable(
        ...
        [
          ...
          ['Founder Plan™',   '$299', '$199/mo', '$1,990/yr',       '$36/mo for 3 months'],
          ['Enterprise Plan™','$599', '$399/mo', '\u2014',          '$100/mo for 3 months'],
          ['Agency Edition™',   '$699', '$899/mo', 'Annual contract', '$139/mo for 3 months'],
        ],
        [1800, 1200, 1200, 1800, 3360]
      ),
      spacer(),
      highlight('Founder Plan™ Introductory Rate: $199/month. When the BluWav Growth Dashboard launches, the price moves to $199/month. Clients who sign now lock in $199 for life. Use this in every CRM conversation.'),
      spacer(),
      ...
      scriptLine('Founder Plan™ is $199 per month right now. That is our introductory rate for early adopters. When we launch the BluWav Growth Dashboard, the price moves to $199. Sign up today and your rate is locked in for life. No exceptions.'),
      spacer(),
      h2('Closing Script'),
